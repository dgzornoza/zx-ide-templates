...
Game templates for Zx-IDE, a Visual Studio Code extension for retro game development. This repository provides ready-to-use project templates for Zx-IDE, allowing developers to quickly start building their games with Zx-IDE.

## Templates

Currently the following types of game templates are available:
